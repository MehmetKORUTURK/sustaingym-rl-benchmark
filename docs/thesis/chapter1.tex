...
\begin{description}
    ...
    \item[RQ5 (Cross-Environment Insights):] Are there universal patterns in algorithm performance and noise sensitivity across the three environments, or is performance highly environment-specific?
\end{description}
...
\textbf{Chapter~\ref{ch:conclusion}: Conclusion and Future Work} summarizes the key findings of this thesis, discusses limitations, and outlines directions for future research including transfer learning across environments, curriculum-based noise training, and real-world deployment considerations.
