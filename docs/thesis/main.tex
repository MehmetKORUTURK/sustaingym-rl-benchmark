...
Our evaluation employs rigorous statistical methodology following current best practices: five independent seeds per configuration, interquartile mean (IQM) reporting, and bootstrap 95\% confidence intervals. The resulting benchmark comprises over 700 training runs across three environments, three algorithms, and multiple noise levels, providing actionable insights for practitioners deploying RL controllers in real-world energy systems.
...
TCTN & Train-Clean-Test-Noisy \\
TD3 & Twin Delayed Deep Deterministic Policy Gradient \\
TNTC & Train-Noisy-Test-Clean \\
ZOH & Zero-Order Hold \\
\bottomrule
\end{tabular}
